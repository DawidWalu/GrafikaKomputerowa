...
public class SceneGraph extends JPanel {
	...
	private void createWorld() {
		...
		T1.setScale(0.5, 1.2).setTranslation(0, -2).setColor(new Color(0,0,255));
		L1.setRotation(-22.5).setScale(2, 0.1).setTranslation(0, -0.8).setColor(new Color(255,0,0));
		L2.setRotation(-22.5).setScale(1.79, 0.1).setTranslation(-2.2, 1.50).setColor(new Color(255,0,0));
		L3.setRotation(-22.5).setScale(1.48, 0.08).setTranslation(1.5, 1.8).setColor(new Color(255,0,0));
