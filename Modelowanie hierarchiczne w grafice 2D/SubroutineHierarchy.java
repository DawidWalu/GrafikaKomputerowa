...
public class SubroutineHierarchy extends JPanel {
	...
	private void drawWorld(Graphics2D g2) {
		...
		rotatingPolygon(g2, 100, -1.02, -0.05); // Graphics2D, promienn, translate_x, translate_y
		...
		R_Line(g2, 1, 1.05, 0, -0.46, new Color(255 ,0, 0)); // Graphics2D, skala_x, skala_y, translate_x, translate_y, color
		R_Line(g2, 0.85, 0.95, -2.6, 1.87, new Color(255 ,0, 0));
		R_Line(g2, 0.6, 0.7, 2.47, 2.47, new Color(255 ,0, 0));

		Triangle(g2, 0.4, 0.5, 0, -2, new Color(0 ,0, 255)); // Graphics2D, skala_x, skala_y, translate_x, translate_y, color
